...
parser.add_argument("--run", action="store_true", help="Run the main harness loop")
parser.add_argument("--aggregate", action="store_true", help="Aggregate results")
parser.add_argument("--check-timeouts", action="store_true", help="Check for timeouts")
parser.add_argument("--tables", action="store_true", help="Generate tables and plots")
args = parser.parse_args()
run_all = not (args.run or args.aggregate or args.check_timeouts or args.tables)
...
if run_all or args.check_timeouts:
    # check for timeouts
...
\newcommand{\tool}{Greta}
\newcommand{\menhir}{Menhir}
\newcommand{\wrt}{w.r.t.\ }
\newcommand{\Bstrut}{\rule[-0.5ex]{0pt}{0pt}}
\begin{document}
""" + latex_table + r"""
\end{document}
"""
