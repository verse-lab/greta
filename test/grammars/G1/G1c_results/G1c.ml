...
module MenhirBasics = struct
  ...
  type token = 
    | VAR of (
# 16 "grammars/G1/G1s/G1c.mly"
       (Range.t * string)
# 15 "grammars/G1/G1s/G1c.ml"
  )
    | TRUE of (
# 23 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 20 "grammars/G1/G1s/G1c.ml"
  )
    | TILDE of (
# 22 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 25 "grammars/G1/G1s/G1c.ml"
  )
    | RPAREN of (
# 21 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 30 "grammars/G1/G1s/G1c.ml"
  )
    | LPAREN of (
# 20 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 35 "grammars/G1/G1s/G1c.ml"
  )
    | FALSE of (
# 24 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 40 "grammars/G1/G1s/G1c.ml"
  )
    | EOF
    | BAR of (
# 18 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 46 "grammars/G1/G1s/G1c.ml"
  )
    | ARR of (
# 17 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 51 "grammars/G1/G1s/G1c.ml"
  )
    | AMPER of (
# 19 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 56 "grammars/G1/G1s/G1c.ml"
  )
...
# 11 "grammars/G1/G1s/G1c.mly"
  
open Ast;;

# 67 "grammars/G1/G1s/G1c.ml"
...
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 105 "grammars/G1/G1s/G1c.ml"
)
...
# 22 "grammars/G1/G1s/G1c.mly"
       (Range.t)
# 140 "grammars/G1/G1s/G1c.ml"
)

and _menhir_box_toplevel = 
  | MenhirBox_toplevel of (
# 28 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 147 "grammars/G1/G1s/G1c.ml"
) [@@unboxed]

let _menhir_action_01 =
  fun _1 ->
    (
# 37 "grammars/G1/G1s/G1c.mly"
                          ( _1 )
# 155 "grammars/G1/G1s/G1c.ml"
     : (
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 159 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_02 =
  fun x ->
    (
# 38 "grammars/G1/G1s/G1c.mly"
                          ( Var (snd x) )
# 167 "grammars/G1/G1s/G1c.ml"
     : (
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 171 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_03 =
  fun l r ->
    (
# 39 "grammars/G1/G1s/G1c.mly"
                          ( Imp(l, r) )
# 179 "grammars/G1/G1s/G1c.ml"
     : (
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 183 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_04 =
  fun l r ->
    (
# 40 "grammars/G1/G1s/G1c.mly"
                          ( Or(l, r) )
# 191 "grammars/G1/G1s/G1c.ml"
     : (
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 195 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_05 =
  fun l r ->
    (
# 41 "grammars/G1/G1s/G1c.mly"
                          ( And(l, r) )
# 203 "grammars/G1/G1s/G1c.ml"
     : (
# 29 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 207 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_06 =
  fun () ->
    (
# 44 "grammars/G1/G1s/G1c.mly"
                          ( True )
# 215 "grammars/G1/G1s/G1c.ml"
     : (
# 30 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 219 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_07 =
  fun () ->
    (
# 45 "grammars/G1/G1s/G1c.mly"
                          ( False )
# 227 "grammars/G1/G1s/G1c.ml"
     : (
# 30 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 231 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_08 =
  fun b ->
    (
# 46 "grammars/G1/G1s/G1c.mly"
                          ( Not(b) )
# 239 "grammars/G1/G1s/G1c.ml"
     : (
# 30 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 243 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_09 =
  fun b ->
    (
# 47 "grammars/G1/G1s/G1c.mly"
                          ( b )
# 251 "grammars/G1/G1s/G1c.ml"
     : (
# 30 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 255 "grammars/G1/G1s/G1c.ml"
    ))

let _menhir_action_10 =
  fun b ->
    (
# 34 "grammars/G1/G1s/G1c.mly"
                ( b )
# 263 "grammars/G1/G1s/G1c.ml"
     : (
# 28 "grammars/G1/G1s/G1c.mly"
      (Ast.bexp)
# 267 "grammars/G1/G1s/G1c.ml"
    ))
