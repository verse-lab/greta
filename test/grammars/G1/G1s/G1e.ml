...
module MenhirBasics = struct
  ...
  type token = 
    | VAR of (
# 23 "grammars/G1/G1s/G1e.mly"
       (Range.t * string)
# 15 "grammars/G1/G1s/G1e.ml"
  )
    | TRUE of (
# 30 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 20 "grammars/G1/G1s/G1e.ml"
  )
    | TILDE of (
# 29 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 25 "grammars/G1/G1s/G1e.ml"
  )
    | RPAREN of (
# 28 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 30 "grammars/G1/G1s/G1e.ml"
  )
    | LPAREN of (
# 27 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 35 "grammars/G1/G1s/G1e.ml"
  )
    | FALSE of (
# 31 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 40 "grammars/G1/G1s/G1e.ml"
  )
    | EOF
    | BAR of (
# 25 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 46 "grammars/G1/G1s/G1e.ml"
  )
    | ARR of (
# 24 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 51 "grammars/G1/G1s/G1e.ml"
  )
    | AMPER of (
# 26 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 56 "grammars/G1/G1s/G1e.ml"
  )
...
# 18 "grammars/G1/G1s/G1e.mly"
  
open Ast;;

# 67 "grammars/G1/G1s/G1e.ml"
...
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 105 "grammars/G1/G1s/G1e.ml"
)
...
# 29 "grammars/G1/G1s/G1e.mly"
       (Range.t)
# 140 "grammars/G1/G1s/G1e.ml"
)

and _menhir_box_toplevel = 
  | MenhirBox_toplevel of (
# 36 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 147 "grammars/G1/G1s/G1e.ml"
) [@@unboxed]

let _menhir_action_01 =
  fun () ->
    (
# 44 "grammars/G1/G1s/G1e.mly"
                        ( True )
# 155 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 159 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_02 =
  fun () ->
    (
# 45 "grammars/G1/G1s/G1e.mly"
                        ( False )
# 167 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 171 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_03 =
  fun x ->
    (
# 46 "grammars/G1/G1s/G1e.mly"
                        ( Var (snd x) )
# 179 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 183 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_04 =
  fun l r ->
    (
# 47 "grammars/G1/G1s/G1e.mly"
                        ( Imp(l, r) )
# 191 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 195 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_05 =
  fun l r ->
    (
# 48 "grammars/G1/G1s/G1e.mly"
                        ( Or(l, r) )
# 203 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 207 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_06 =
  fun l r ->
    (
# 49 "grammars/G1/G1s/G1e.mly"
                        ( And(l, r) )
# 215 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 219 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_07 =
  fun b ->
    (
# 50 "grammars/G1/G1s/G1e.mly"
                        ( Not(b) )
# 227 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 231 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_08 =
  fun b ->
    (
# 51 "grammars/G1/G1s/G1e.mly"
                         ( b )
# 239 "grammars/G1/G1s/G1e.ml"
     : (
# 37 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 243 "grammars/G1/G1s/G1e.ml"
    ))

let _menhir_action_09 =
  fun b ->
    (
# 41 "grammars/G1/G1s/G1e.mly"
               ( b )
# 251 "grammars/G1/G1s/G1e.ml"
     : (
# 36 "grammars/G1/G1s/G1e.mly"
      (Ast.bexp)
# 255 "grammars/G1/G1s/G1e.ml"
    ))
