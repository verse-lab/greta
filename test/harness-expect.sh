...
proc get_cli_command {path} {
    ...
    set base_grammar_file "grammars/G3/G3s/G3a"
    ...
    set cli_command "$binary_exec $grammar_file$grammar_extension $base_grammar_file$conflicts_extension $base_grammar_file$config_extension"

    return [list $cli_command $grammar_file$grammar_extension]
}
...
foreach file {"grammars/G3/G3s/G3a.mly" "grammars/G3/G3s/G3a.conflicts" "grammars/G3/G3s/G3a.cfg"} {
    if {[file exists $file]} {
