...
ex1:
  | e1=ex2 PLUS e2=ex1  { loc $startpos $endpos @@ Bop(Add, e1, e2) }
  | ex2  { $1 }
  ;

ex2:
  | ex4  { $1 }
  | e1=ex2 DASH e2=ex2  { loc $startpos $endpos @@ Bop(Sub, e1, e2) }
  ;

ex4:
  | ex6  { $1 }
  | e1=ex4 STAR e2=ex6  { loc $startpos $endpos @@ Bop(Mul, e1, e2) }
  ;
