...
exp23:
  | e1=exp23 STAR e2=exp24  { loc $startpos $endpos @@ Bop(Mul, e1, e2) }
  | exp24  { $1 }
  ;
...
stmt1:
  | stmt2  { $1 }
  | IF LPAREN e=ex5 RPAREN s1=stmt1  { loc $startpos $endpos @@ If(e, [s1], []) }
  ;

stmt2:
  | id=iden8 EQ e=ex5 SEMI  { loc $startpos $endpos @@ Assn(id, e) }
  | IF LPAREN e=ex5 RPAREN s1=stmt2 ELSE s2=stmt2  { loc $startpos $endpos @@ If(e, [s1], [s2]) }
