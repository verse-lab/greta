...
ex24:
  | e1=ex32 PLUS e2=exp26  {  loc $startpos $endpos @@ Bop(Add, e1, e2)  }
  | e1=ex27 DASH e2=ex27  {  loc $startpos $endpos @@ Bop(Sub, e1, e2)  }
  | exp211  {  $1  }
  ;
...
exp210:
  ...
  | e1=exp223 STAR e2=exp27  {  loc $startpos $endpos @@ Bop(Mul, e1, e2)  }
...
stmt1:
  ...
  | IF LPAREN e=ex25 RPAREN s1=stmt4  {  loc $startpos $endpos @@ If(e, [s1], [])  }
  | IF LPAREN e=ex24 RPAREN s1=stmt1 ELSE s2=stmt1  {  loc $startpos $endpos @@ If(e, [s1], [s2])  }
