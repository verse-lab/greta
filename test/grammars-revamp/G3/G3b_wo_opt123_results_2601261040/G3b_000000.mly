...
ex1:
  | e1=ex12 STAR e2=ex23  {  loc $startpos $endpos @@ Bop(Mul, e1, e2)  }
  | c=cons51  {  loc $startpos $endpos @@ Const (c)  }
  | LPAREN e=ex4 RPAREN  {  e  }
  | e1=ex10 DASH e2=ex10  {  loc $startpos $endpos @@ Bop(Sub, e1, e2)  }
  | id=iden33  {  loc $startpos $endpos @@ Id (id)  }
  | e1=ex4 PLUS e2=ex10  {  loc $startpos $endpos @@ Bop(Add, e1, e2)  }
  ;
...
stmt11:
  ...
  | IF LPAREN e=ex2 RPAREN s1=stmt11 ELSE s2=stmt11  {  loc $startpos $endpos @@ If(e, [s1], [s2])  }
  ;
...
stmt7:
  ...
  | stmt13  {  $1  }
  | d=decl36 SEMI  {  loc $startpos $endpos @@ Decl(d)  }
  | IF LPAREN e=ex1 RPAREN s1=stmt7  {  loc $startpos $endpos @@ If(e, [s1], [])  }
  ;
