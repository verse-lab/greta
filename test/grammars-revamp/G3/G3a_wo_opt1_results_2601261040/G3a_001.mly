...
ex7:
  | e1=ex7 PLUS e2=exp23  {  loc $startpos $endpos @@ Bop(Add, e1, e2)  }
  | ex9  { $1 }
  ;
...
stmt1:
  | stmt2  { $1 }
  | IF LPAREN e=ex7 RPAREN s1=stmt1  {  loc $startpos $endpos @@ If(e, [s1], [])  }
  ;

stmt2:
  | IF LPAREN e=ex7 RPAREN s1=stmt2 ELSE s2=stmt2  {  loc $startpos $endpos @@ If(e, [s1], [s2])  }
  | stmt5  { $1 }
  ;
