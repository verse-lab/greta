...
stmt2:
  | IF LPAREN e=ex10 RPAREN s1=stmt1 ELSE s2=stmt1  {  loc $startpos $endpos @@ If(e, [s1], [s2])  }
  | stmt5  { $1 }
  ;

stmt5:
  | IF LPAREN e=ex11 RPAREN s1=stmt5  {  loc $startpos $endpos @@ If(e, [s1], [])  }
  | stmt9  {  $1  }
  | d=decl18 SEMI  {  loc $startpos $endpos @@ Decl(d)  }
  | id=iden19 EQ e=ex10 SEMI  {  loc $startpos $endpos @@ Assn(id, e)  }
  ;
