...
exp15:
  | exp16  { $1 }
  | e1=exp15 PLUS e2=exp22  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  ;

exp16:
  | e1=exp16 EQEQ e2=exp112  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | exp112  { $1 }
  ;
...
vdec8:
  | VAR id=iden11 EQ init=exp13  {  loc $startpos $endpos @@ {id; init}  }
  ;
