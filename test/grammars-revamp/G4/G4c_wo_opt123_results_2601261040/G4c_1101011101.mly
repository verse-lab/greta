...
ex11:
  | e1=ex16 EQEQ e2=ex15  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | e1=ex14 STAR e2=ex11  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | e1=ex16 PLUS e2=ex47  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | exp24  {  $1  }
  | e1=ex15 DASH e2=ex14  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  ;
