...
ex3:
  | e1=ex6 DASH e2=ex8  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | e1=ex6 STAR e2=ex5  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | exp22  {  $1  }
  | e1=ex4 PLUS e2=ex5  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | e1=ex4 EQEQ e2=ex3  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  ;
...
vdec11:
  | VAR id=iden9 EQ init=ex3  {  loc $startpos $endpos @@ {id; init}  }
  ;
