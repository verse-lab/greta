...
exp222:
  | exp313  {  $1   }
  | e1=exp223 STAR e2=exp242  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  ;
...
exp312:
  | e1=exp341 EQEQ e2=exp321  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | exp49  {  $1   }
  | DASH e=exp315  {  loc $startpos $endpos @@ Uop (Neg, e)  }
  ;
