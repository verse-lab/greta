...
exp111:
  | e1=exp114 STAR e2=exp115  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | exp24  {  $1  }
  | e1=exp116 PLUS e2=exp27  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | e1=exp115 DASH e2=exp116  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | e1=exp114 EQEQ e2=exp111  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  ;
