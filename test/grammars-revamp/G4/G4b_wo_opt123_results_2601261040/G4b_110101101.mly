...
exp111:
  | e1=exp111 STAR e2=exp114  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | exp24  {  $1  }
  | e1=exp116 PLUS e2=exp27  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | e1=exp115 DASH e2=exp114  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | e1=exp116 EQEQ e2=exp115  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  ;
