...
ex7:
  | e1=ex7 EQEQ e2=ex8  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | ex8  { $1 }
  ;

ex8:
  | ex9  { $1 }
  | e1=ex9 STAR e2=ex8  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  ;

ex9:
  | e1=ex9 DASH e2=ex11  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | ex11  { $1 }
  ;
