...
ex6:
  | e1=ex5 PLUS e2=ex7  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | ex7  { $1 }
  ;

ex7:
  | ex8  { $1 }
  | e1=ex7 STAR e2=ex8  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  ;

ex8:
  | ex9  { $1 }
  | e1=ex9 DASH e2=ex8  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  ;

ex9:
  | ex11  { $1 }
  | e1=ex11 EQEQ e2=ex9  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  ;
