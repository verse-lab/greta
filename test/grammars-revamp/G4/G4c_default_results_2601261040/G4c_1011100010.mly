...
ex3:
  | e1=ex4 PLUS e2=ex3  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | ex4  { $1 }
  ;

ex4:
  | e1=ex4 EQEQ e2=ex5  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | ex5  { $1 }
  ;

ex5:
  | ex6  { $1 }
  | e1=ex5 STAR e2=ex6  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  ;

ex6:
  | e1=ex8 DASH e2=ex6  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | ex8  { $1 }
  ;
