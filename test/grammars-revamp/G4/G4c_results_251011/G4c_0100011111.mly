...
ex3:
  | e1=ex3 DASH e2=ex4  { loc $startpos $endpos @@ Bop (Sub, e1, e2) }
  | ex4  { $1 }
  ;

ex4:
  | ex5  { $1 }
  | e1=ex5 STAR e2=ex4  { loc $startpos $endpos @@ Bop (Mul, e1, e2) }
  ;

ex5:
  | ex6  { $1 }
  | e1=ex6 EQEQ e2=ex5  { loc $startpos $endpos @@ Bop (Eq, e1, e2) }
  ;

ex6:
  | e1=ex8 PLUS e2=ex6  { loc $startpos $endpos @@ Bop (Add, e1, e2) }
  | ex8  { $1 }
  ;
