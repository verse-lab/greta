...
ex3:
  | e1=ex4 DASH e2=ex3  { loc $startpos $endpos @@ Bop (Sub, e1, e2) }
  | ex4  { $1 }
  ;

ex4:
  | e1=ex5 PLUS e2=ex4  { loc $startpos $endpos @@ Bop (Add, e1, e2) }
  | ex5  { $1 }
  ;
...
ex6:
  | e1=ex8 EQEQ e2=ex6  { loc $startpos $endpos @@ Bop (Eq, e1, e2) }
  | ex8  { $1 }
  ;
