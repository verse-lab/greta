...
exp110:
  | e1=exp112 STAR e2=exp110  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | exp112  { $1 }
  ;
...
exp17:
  | e1=exp16 EQEQ e2=exp18  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | exp18  { $1 }
  ;
...
exp19:
  | e1=exp110 DASH e2=exp19  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | exp110  { $1 }
  ;
