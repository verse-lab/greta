...
exp110:
  | exp112  { $1 }
  | e1=exp110 DASH e2=exp112  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  ;
...
exp17:
  | exp18  { $1 }
  | e1=exp18 STAR e2=exp16  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  ;
...
exp19:
  | e1=exp110 EQEQ e2=exp19  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  | exp110  { $1 }
  ;
