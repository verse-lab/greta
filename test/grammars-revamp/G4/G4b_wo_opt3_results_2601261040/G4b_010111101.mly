...
exp13:
  | e1=exp14 DASH e2=exp13  {  loc $startpos $endpos @@ Bop (Sub, e1, e2)  }
  | exp22  {  $1  }
  | e1=exp15 STAR e2=exp16  {  loc $startpos $endpos @@ Bop (Mul, e1, e2)  }
  | e1=exp16 PLUS e2=exp22  {  loc $startpos $endpos @@ Bop (Add, e1, e2)  }
  | e1=exp15 EQEQ e2=exp14  {  loc $startpos $endpos @@ Bop (Eq, e1, e2)  }
  ;
