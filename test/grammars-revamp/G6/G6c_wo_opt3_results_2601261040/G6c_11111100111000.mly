...
int_2:
  | IVAR  {  Ivar  }
  | int_6 TIMES int_4  {  Times($1, $3)  }
  | MINUS int_6  {  Negative($2)  }
  | INT  {  Int  }
  | int_2 DIVIDE int_3  {  Divide($1, $3)  }
  | int_4 POWER int_3  {  Power($1, $3)  }
  ;
