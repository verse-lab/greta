...
int_12:
  | int_14 MINUS int_11  {  Minus($1, $3)  }
  | int_14  { $1 }
  ;

int_14:
  | int_15  { $1 }
  | int_15 PLUS int_14  {  Plus($1, $3)  }
  ;
...
int_4:
  | int_5  { $1 }
  | int_3 DIVIDE int_5  {  Divide($1, $3)  }
  ;

int_5:
  | int_6 TIMES int_5  {  Times($1, $3)  }
  | int_6  { $1 }
  ;

int_6:
  | int_9 POWER int_6  {  Power($1, $3)  }
  | int_9  { $1 }
  ;
