...
cond3:
  | cond4  { $1 }
  | cond3 OR cond4  { Or  ($1, $3) }
  ;

cond4:
  | cond4 AND cond6  { And  ($1, $3) }
  | cond6  { $1 }
  ;

cond6:
  | col_22 BETWEEN real8 AND real8  { Between ($1, $3, $5) }
  | col_22 COMPARISION_OPERATOR real8  { Compare ($2, $1, $3) }
...
expr2:
  | expr5  { $1 }
  | expr5 STAR expr2  { Star ($1, $3) }
  ;

expr5:
  | expr7 DIV expr5  { Div ($1, $3) }
  | expr7  { $1 }
  ;

expr7:
  | expr9  { $1 }
  | expr7 MINUS expr9  { Minus ($1, $3) }
  ;
