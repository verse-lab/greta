...
module MenhirBasics = struct
  ...
  type token = 
    | VAR of (
# 13 "grammars-revamp/G2/G2a.mly"
       (Range.t * string)
# 15 "grammars-revamp/G2/G2a.ml"
  )
    | TRUE of (
# 20 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 20 "grammars-revamp/G2/G2a.ml"
  )
    | TILDE of (
# 19 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 25 "grammars-revamp/G2/G2a.ml"
  )
    | RPAREN of (
# 18 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 30 "grammars-revamp/G2/G2a.ml"
  )
    | LPAREN of (
# 17 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 35 "grammars-revamp/G2/G2a.ml"
  )
    | FALSE of (
# 21 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 40 "grammars-revamp/G2/G2a.ml"
  )
    | EOF
    | BAR of (
# 15 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 46 "grammars-revamp/G2/G2a.ml"
  )
    | ARR of (
# 14 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 51 "grammars-revamp/G2/G2a.ml"
  )
    | AMPER of (
# 16 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 56 "grammars-revamp/G2/G2a.ml"
  )
...
# 8 "grammars-revamp/G2/G2a.mly"
  
open Ast;;

# 67 "grammars-revamp/G2/G2a.ml"
...
# 26 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 105 "grammars-revamp/G2/G2a.ml"
)

and ('s, 'r) _menhir_cell1_bexp2 = 
  | MenhirCell1_bexp2 of 's * ('s, 'r) _menhir_state * (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 112 "grammars-revamp/G2/G2a.ml"
)
...
# 19 "grammars-revamp/G2/G2a.mly"
       (Range.t)
# 147 "grammars-revamp/G2/G2a.ml"
)

and _menhir_box_toplevel = 
  | MenhirBox_toplevel of (
# 25 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 154 "grammars-revamp/G2/G2a.ml"
) [@@unboxed]

let _menhir_action_01 =
  fun _1 ->
    (
# 34 "grammars-revamp/G2/G2a.mly"
                          ( _1 )
# 162 "grammars-revamp/G2/G2a.ml"
     : (
# 26 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 166 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_02 =
  fun x ->
    (
# 35 "grammars-revamp/G2/G2a.mly"
                          ( Var (snd x) )
# 174 "grammars-revamp/G2/G2a.ml"
     : (
# 26 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 178 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_03 =
  fun l r ->
    (
# 36 "grammars-revamp/G2/G2a.mly"
                          ( Or(l, r) )
# 186 "grammars-revamp/G2/G2a.ml"
     : (
# 26 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 190 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_04 =
  fun l r ->
    (
# 37 "grammars-revamp/G2/G2a.mly"
                          ( And(l, r) )
# 198 "grammars-revamp/G2/G2a.ml"
     : (
# 26 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 202 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_05 =
  fun () ->
    (
# 40 "grammars-revamp/G2/G2a.mly"
                          ( True )
# 210 "grammars-revamp/G2/G2a.ml"
     : (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 214 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_06 =
  fun () ->
    (
# 41 "grammars-revamp/G2/G2a.mly"
                          ( False )
# 222 "grammars-revamp/G2/G2a.ml"
     : (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 226 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_07 =
  fun l r ->
    (
# 42 "grammars-revamp/G2/G2a.mly"
                          ( Imp(l, r) )
# 234 "grammars-revamp/G2/G2a.ml"
     : (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 238 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_08 =
  fun b ->
    (
# 43 "grammars-revamp/G2/G2a.mly"
                          ( Not(b) )
# 246 "grammars-revamp/G2/G2a.ml"
     : (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 250 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_09 =
  fun b ->
    (
# 44 "grammars-revamp/G2/G2a.mly"
                          ( b )
# 258 "grammars-revamp/G2/G2a.ml"
     : (
# 27 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 262 "grammars-revamp/G2/G2a.ml"
    ))

let _menhir_action_10 =
  fun b ->
    (
# 31 "grammars-revamp/G2/G2a.mly"
                ( b )
# 270 "grammars-revamp/G2/G2a.ml"
     : (
# 25 "grammars-revamp/G2/G2a.mly"
      (Ast.bexp)
# 274 "grammars-revamp/G2/G2a.ml"
    ))
